...
def main():
	...
	time_map3 = {'Campus': {'Campus': None, 'Whole_Food': 12, 'Beach': 3, 'Cinema': None, 'Lighthouse': 1, 'Ryan Field': None, 'YWCA': None},
	...
	student_score3 = sc.a_star_search(dis_map,time_map3, 'Campus', 'Cinema')
	gold_score3 = {'Ryan Field': {'YWCA': 11, 'Lighthouse': 11}, 'Whole_Food': {'Beach': 19, 'Campus': 16, 'Cinema': 10}, 'Lighthouse': {'Ryan Field': 9, 'Campus': 7}, 'Beach': {'Whole_Food': 10, 'Campus': 12}, 'Campus': {'Lighthouse': 8, 'Beach': 11, 'Whole_Food': 15}}
	if check_score_equal(student_score3,gold_score3):
		print "pass A* search for time map3"
	else:
		print "Fail A* search for time map3"
		exit(1)
	exit(0)
